from eficiencia_motor import calcular_eficiencia
from eficiencia_motor import classificar_eficiencia
from eficiencia_motor import analise_motor
...
def test_analise_motor():
    ...
    assert resultado['classificação'] == 'IE2 - Eficiência média'